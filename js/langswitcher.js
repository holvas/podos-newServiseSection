const translations = {
    ...
    uk: {
        ...
        "home-intro": "PodOS полодогічний кабінет (Вроцлав) – це місце, де турбота про здоров’я та естетику ніг поєднується з професіоналізмом та сучасними методами лікування. Мене звуть Олена Степанюк, я кваліфікований спеціаліст подолог і пропоную комплексні послуги з подології, які допомагають зберегти здоров’я ніг незалежно від віку та проблем. Якщо ви шукаєте ефективні рішення такі, як догляд за ногами у Вроцлаві, PodOS — це правильне місце для вас.",
